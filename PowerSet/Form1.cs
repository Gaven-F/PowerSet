...
namespace PowerSet
{
    public partial class Form1 : Form
    {
        ...
        //参数界面参数定义
        public static int KInitCurrent,
            NaInitCurrent,
            CsInitCurrent,
            SbInitCurrent; //电源启动电流
        public static int KAddCurrent,
            NaAddCurrent,
            CsAddCurrent,
            SbAddCurrent; //电源增加电流
        public static int KIntervalTime = 10,
            NaIntervalTime = 10,
            CsIntervalTime = 10,
            SbIntervalTime = 10; //电源间隔时间
        public static int KPeriod = 10,
            NaPeriod = 10,
            CsPeriod = 10,
            SbPeriod = 10; //电源周期
        public static int KVoltage = 25,
            NaVoltage = 25,
            CsVoltage = 25,
            SbVoltage = 25; //电源电压
        public static int KMaxTime,
            NaMaxTime,
            CsMaxTime,
            SbMaxTime; //电源关闭时间
        public static long KTimePeriodCount,
            NaTimePeriodCount,
            CsTimePeriodCount,
            SbTimePeriodCount; //周期计时
        public static int KPeriodCount,
            NaPeriodCount,
            CsPeriodCount,
            SbPeriodCount; //周期执行数
        public static int XIntervalTime = 10,
            XMaxTime = 40;
        public static double YIntervalAmpere = 0.5,
            YMaxAmpere = 4;

        public static long TimeCnt = 0;

        public static bool TotalPauseFlag; //暂停标志
        public const int KIndex = 12,
            NaIndex = 12,
            CsIndex = 12,
            SbIndex = 12;
        public static int[] KT1Cur = new int[KIndex]
        {
            1000,
            1500,
            2000,
        ...
        public static int[] KT1Execution = new int[KIndex]
        {
            10,
            10,
            30,
        ...
        public static int[] KT1TurnOff = new int[KIndex]
        {
            0,
            0,
            30,
        ...
        public static int[] NaT1Cur = new int[NaIndex]
        {
            1000,
            1500,
            2000,
        ...
        public static int[] NaT1Execution = new int[NaIndex]
        {
            10,
            10,
            30,
        ...
        public static int[] NaT1TurnOff = new int[NaIndex]
        {
            0,
            0,
            30,
        ...
        public static int[] CsT1Cur = new int[CsIndex]
        {
            1000,
            1500,
            2000,
        ...
        public static int[] CsT1Execution = new int[CsIndex]
        {
            10,
            10,
            30,
        ...
        public static int[] CsT1TurnOff = new int[CsIndex]
        {
            0,
            0,
            30,
        ...
        public static int[] SbT1Cur = new int[SbIndex]
        {
            1000,
            1500,
            2000,
        ...
        public static int[] SbT1Execution = new int[SbIndex]
        {
            10,
            10,
            30,
        ...
        public static int[] SbT1TurnOff = new int[SbIndex]
        {
            0,
            0,
            30,
        ...
        public static int KCurIndex = 0,
            NaCurIndex = 0,
            CsCurIndex = 0,
            SbCurIndex = 0;
        public static long KOpenTimeCnt = 0,
            NaOpenTimeCnt = 0,
            CsOpenTimeCnt = 0,
            SbOpenTimeCnt = 0,
            KCloseTimeCnt = 0,
        ...
        private void But_Stare_Click(object sender, EventArgs e)
        {
            if (But_Stare.Text == "开 始")
            {
                ...
                textBox_InFo.AppendText(
                    DateTime.Now.ToString("yyyy年MM月dd日HH:mm:ss") + " :" + "工艺开始" + "\r\n"
                );
            }
            else //暂停
            {
                if (But_Stare.Text == "暂 停")
                {
                    ...
                    SbPauseFlag = 1; //暂停标志位
                    textBox_InFo.AppendText(
                        DateTime.Now.ToString("yyyy年MM月dd日HH:mm:ss") + " :" + "工艺暂停" + "\r\n"
                    );
                }
                else //继续
                {
                    ...
                    SbContinueFlag = 1;
                    textBox_InFo.AppendText(
                        DateTime.Now.ToString("yyyy年MM月dd日HH:mm:ss") + " :" + "工艺继续" + "\r\n"
                    );
                }
            }
        }
        ...
        private void But_End_Click(object sender, EventArgs e)
        {
            ...
            But_Stare.Text = "开 始";
            textBox_InFo.AppendText(
                DateTime.Now.ToString("yyyy年MM月dd日HH:mm:ss") + " :" + "工艺结束" + "\r\n"
            );
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                Control Execution =
                    this.Controls.Find(TExecution, true).FirstOrDefault() as NumericUpDown;
                if (Execution != null)
                {
                ...
                Control TurnOff =
                    this.Controls.Find(TTurnOff, true).FirstOrDefault() as NumericUpDown;
                if (TurnOff != null)
                {
                ...
                Control NaExecution =
                    this.Controls.Find(NaTExecution, true).FirstOrDefault() as NumericUpDown;
                if (NaExecution != null)
                {
                ...
                Control NaTurnOff =
                    this.Controls.Find(NaTTurnOff, true).FirstOrDefault() as NumericUpDown;
                if (NaTurnOff != null)
                {
                ...
                Control CsExecution =
                    this.Controls.Find(CsTExecution, true).FirstOrDefault() as NumericUpDown;
                if (CsExecution != null)
                {
                ...
                Control CsTurnOff =
                    this.Controls.Find(CsTTurnOff, true).FirstOrDefault() as NumericUpDown;
                if (CsTurnOff != null)
                {
                ...
                Control SbExecution =
                    this.Controls.Find(SbTExecution, true).FirstOrDefault() as NumericUpDown;
                if (SbExecution != null)
                {
                ...
                Control SbTurnOff =
                    this.Controls.Find(SbTTurnOff, true).FirstOrDefault() as NumericUpDown;
                if (SbTurnOff != null)
                {
                    ...
                    if (KPauseFlag == 1)
                    {
                        ...
                        if (length1 == 8)
                        {
                            ...
                            ) //判断帧头 01 06 00 1B
                            {
                                ...
                                textBox_InFo.AppendText(
                                    (GYTime / 3600).ToString("00")
                                        + ":"
                                        + ((GYTime % 3600) / 60).ToString("00")
                                        + ":"
                                        + ((GYTime % 3600) % 60).ToString("00")
                                        + " "
                                        + "K程序已经暂停"
                ...
                if (KCurIndex < KT1Cur.Length) //不能超过数组最大值
                {
                    if (NewOnFlag_K && KStartFlag)
                    {
                        ...
                        if (KOpenTimeCnt >= KT1Execution[KCurIndex])
                        {
                            ...
                            Control Execution =
                                this.Controls.Find(TExecution, true).FirstOrDefault()
                                as NumericUpDown;
                            if (Execution != null)
                            {
                        ...
                        if (CurSetVal_K / 1000.0 >= chart1.ChartAreas[0].AxisY.Maximum)
                        {
                            chart1.ChartAreas[0].AxisY.Maximum =
                                (int)Math.Ceiling(CurSetVal_K / 1000.0) + 1;
                        }
                        ...
                        Control Cur =
                            this.Controls.Find(TCur, true).FirstOrDefault() as NumericUpDown;
                        if (Cur != null)
                        {
                    ...
                    if (!NewOnFlag_K && KStartFlag)
                    {
                        ...
                        if (KCloseTimeCnt >= KT1TurnOff[KCurIndex])
                        {
                            ...
                            Control TurnOff =
                                this.Controls.Find(TTurnOff, true).FirstOrDefault()
                                as NumericUpDown;
                            if (TurnOff != null)
                            {
                            ...
                            Control KLabelControl = this
                                .Controls.Find(KLabelName, true)
                                .FirstOrDefault(); // 查找Label控件
                            if (KLabelControl is Label Klabel) // 检查找到的控件是否是Label
                            {
                            ...
                            if (KNsb == KT1Nsb[KCurIndex])
                            {
                                ...
                                Control Nsb =
                                    this.Controls.Find(TNsb, true).FirstOrDefault()
                                    as NumericUpDown;
                                if (Nsb != null)
                                {
                ...
                if (NaCurIndex < NaT1Cur.Length) //不能超过数组最大值
                {
                    if (NewOnFlag_Na && NaStartFlag)
                    {
                        ...
                        if (NaOpenTimeCnt >= NaT1Execution[NaCurIndex])
                        {
                            ...
                            Control NaExecution =
                                this.Controls.Find(NaTExecution, true).FirstOrDefault()
                                as NumericUpDown;
                            if (NaExecution != null)
                            {
                        ...
                        {
                            chart1.ChartAreas[0].AxisY.Maximum =
                                (int)Math.Ceiling(CurSetVal_Na / 1000.0) + 1;
                        }
                    ...
                    if (!NewOnFlag_Na && NaStartFlag)
                    {
                        ...
                        if (NaCloseTimeCnt >= NaT1TurnOff[NaCurIndex])
                        {
                            ...
                            Control NaLabelControl = this
                                .Controls.Find(NaLabelName, true)
                                .FirstOrDefault(); // 查找Label控件
                            if (NaLabelControl is Label Nalabel) // 检查找到的控件是否是Label
                            {
                            ...
                            if (NaNsb == NaT1Nsb[NaCurIndex])
                            {
                                ...
                                Control Nsb =
                                    this.Controls.Find(NaTNsb, true).FirstOrDefault()
                                    as NumericUpDown;
                                if (Nsb != null)
                                {
                                    Nsb.BackColor = Color.Red;
                ...
                if (CsCurIndex < CsT1Cur.Length) //不能超过数组最大值
                {
                    if (NewOnFlag_Cs && CsStartFlag)
                    {
                        ...
                        if (CsOpenTimeCnt >= CsT1Execution[CsCurIndex])
                        {
                            ...
                            Control CsExecution =
                                this.Controls.Find(CsTExecution, true).FirstOrDefault()
                                as NumericUpDown;
                            if (CsExecution != null)
                            {
                        ...
                        {
                            chart1.ChartAreas[0].AxisY.Maximum =
                                (int)Math.Ceiling(CurSetVal_Cs / 1000.0) + 1;
                        }
                    ...
                    if (!NewOnFlag_Cs && CsStartFlag)
                    {
                        ...
                        if (CsCloseTimeCnt >= CsT1TurnOff[CsCurIndex])
                        {
                            ...
                            Control CsLabelControl = this
                                .Controls.Find(CsLabelCsme, true)
                                .FirstOrDefault(); // 查找Label控件
                            if (CsLabelControl is Label Cslabel) // 检查找到的控件是否是Label
                            {
                            ...
                            if (CsNsb == CsT1Nsb[CsCurIndex])
                            {
                                ...
                                Control Nsb =
                                    this.Controls.Find(CsTNsb, true).FirstOrDefault()
                                    as NumericUpDown;
                                if (Nsb != null)
                                {
                                    Nsb.BackColor = Color.Red;
                ...
                if (SbCurIndex < SbT1Cur.Length) //不能超过数组最大值
                {
                    if (NewOnFlag_Sb && SbStartFlag)
                    {
                        ...
                        if (SbOpenTimeCnt >= SbT1Execution[SbCurIndex])
                        {
                            ...
                            Control SbExecution =
                                this.Controls.Find(SbTExecution, true).FirstOrDefault()
                                as NumericUpDown;
                            if (SbExecution != null)
                            {
                        ...
                        {
                            chart1.ChartAreas[0].AxisY.Maximum =
                                (int)Math.Ceiling(CurSetVal_Sb / 1000.0) + 1;
                        }
                    ...
                    if (!NewOnFlag_Sb && SbStartFlag)
                    {
                        ...
                        if (SbCloseTimeCnt >= SbT1TurnOff[SbCurIndex])
                        {
                            ...
                            Control SbLabelControl = this
                                .Controls.Find(SbLabelSbme, true)
                                .FirstOrDefault(); // 查找Label控件
                            if (SbLabelControl is Label Sblabel) // 检查找到的控件是否是Label
                            {
                            ...
                            if (SbNsb == SbT1Nsb[SbCurIndex])
                            {
                                ...
                                Control Nsb =
                                    this.Controls.Find(SbTNsb, true).FirstOrDefault()
                                    as NumericUpDown;
                                if (Nsb != null)
                                {
                                    Nsb.BackColor = Color.Red;
